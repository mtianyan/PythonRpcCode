...
all_structs.append(calc_args)
calc_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [PiRequest, None], None, ),  # 1
)
...
class calc_result(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(calc_result)
calc_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [PiResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'ia', [IllegalArgument, None], None, ),  # 1
)
